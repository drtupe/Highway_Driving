...
This part of the code deals with the position, velocity (of ego vehicle) and sensor fusion data. It intends to reason about the environment. Following are the points lookout to be captured my this block of code:
